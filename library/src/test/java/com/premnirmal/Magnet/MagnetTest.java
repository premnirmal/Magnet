...
@PrepareForTest( { RemoveView.class, Magnet.class } )
public class MagnetTest {
    ...
    @Test
    public void testAddToWindow() throws Exception {
        // given
    ...
    public void testUpdateSize() throws Exception {
        ...
        assertEquals("updateSize method must set width value to displayMetricsMock.widthPixels / 2", displayMetricsMock.widthPixels / 2, width);
        assertEquals("updateSize method must set height value to displayMetricsMock.heightPixels / 2", displayMetricsMock.heightPixels / 2, height);
    }

    @Test
    public void testFlingAway() {
        // when
        magnet.flingAway();
    ...
    @Test
    public void testShowRemoveView() {
        // when
    ...
    @Test
    public void testHideRemoveView() {
        // when
    ...
    public void testSetPosition() {
        ...
        assertEquals("SetPosition method must set x value of layoutParams field.", initialX, layoutParams.x);
        assertEquals("SetPosition method must set x value of layoutParams field.", initialY, layoutParams.y);
    }
}
